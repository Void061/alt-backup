    ...
    return (<div>
        ...
        <div id="view" className="main-category">
            ...
            <div className="category" id="category">
                ...
                <Articoli baseurl={props.BASE_URL} articoli={articoli} />
            ...
            <div className="container_index">
                ...
                <div className="indice_articoli">
                    ...
                    <NestedList baseurl={props.BASE_URL} page="category" setArticoli={setArticoli} articoli={props.articoli_totali.data} categorie={props.categorie.data} />
...
export async function getServerSideProps(context) {
    ...
    const articoli = await fetch(process.env.STRAPI_API_URL+ "articoli?populate=utente.avatar&filters[categorie][id][$eq]=" + id).then(r => r.json());
    ...
    //Per la nested list
    const articoli_totali = await fetch(process.env.STRAPI_API_URL + "articoli?populate=*").then(r => r.json());
