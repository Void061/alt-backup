...
export default function Single(props) {
  ...
  return (
    <div>
      ...
      {/* Header */}
      <Header activeBg={true} position="fixed" />

      {/* Componente */}
      <div className="mt-[150px] mb-[100px] container mx-auto grid grid-cols-1 gap-8 md:grid-cols-3">
        ...
        <div className="">
          ...
          <h4 className="text-xl text-left pl-7 pb-4 border-b-2 border-secundary mb-4">CATEGORIE</h4>
